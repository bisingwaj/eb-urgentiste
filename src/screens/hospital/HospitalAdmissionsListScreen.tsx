...
const styles = StyleSheet.create({
  ...
  headerSub: { color: 'rgba(255,255,255,0.3)', fontSize: 10, fontWeight: '900', letterSpacing: 1.5, marginBottom: 4 },
  ...
  sectionLabel: { color: 'rgba(255,255,255,0.3)', fontSize: 11, fontWeight: '900', letterSpacing: 1.5 },
  ...
  levelLabelText: { fontSize: 10, fontWeight: '900', letterSpacing: 0.5 },
  victimName: { color: '#FFF', fontSize: 22, fontWeight: '900', marginBottom: 4 },
  urgencyType: { color: colors.secondary, fontSize: 11, fontWeight: '800', letterSpacing: 0.8, marginBottom: 12 },
