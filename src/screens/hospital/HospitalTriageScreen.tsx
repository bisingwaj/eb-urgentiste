...
const styles = StyleSheet.create({
  ...
  progressText: { color: colors.textMuted, fontSize: 13, fontWeight: '700', letterSpacing: 1 },
  ...
  vitalLabel: { color: colors.textMuted, fontSize: 13, fontWeight: '800', letterSpacing: 0.5 },
