...
const styles = StyleSheet.create({
  ...
  caseMeta: { color: "rgba(255,255,255,0.4)", fontSize: 11, fontWeight: "600" },
  ...
  addTreatmentLabel: { color: "#FF5252", fontSize: 11, fontWeight: "900" },
  ...
  treatmentMeta: { color: "rgba(255,255,255,0.3)", fontSize: 11, marginTop: 2 },
  groupLabel: { color: "rgba(255,255,255,0.3)", fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  ...
  obsStatusText: { fontSize: 11, fontWeight: "900", flex: 1 },
  obsTime: { color: "rgba(255,255,255,0.3)", fontSize: 11, fontWeight: "700" },
  ...
  examStatus: { fontSize: 11, fontWeight: "900" },
  ...
  actionTime: { color: "rgba(255,255,255,0.3)", fontSize: 11, fontWeight: "700" },
  actionUser: { color: "rgba(255,255,255,0.2)", fontSize: 11, marginTop: 2 },
